                ...
                <form className="flex flex-col gap-4" onSubmit={handleLogin}>
                  ...
                  <div className="flex items-center justify-between mt-2">
                    <div className="flex items-center gap-3">
                        <p className="text-sm text-[#111818] dark:text-gray-300 font-normal leading-normal flex-1 truncate">Remember Me</p>
                    </div>
                    <div className="shrink-0">
                        <label className="relative flex h-6 w-11 cursor-pointer items-center rounded-full border-none bg-gray-200 dark:bg-gray-700 p-0.5 has-[:checked]:justify-end has-[:checked]:bg-primary-dark">
                            <div className="h-5 w-5 rounded-full bg-white transition-transform duration-200 shadow-sm"></div>
                            <input className="invisible absolute" type="checkbox" />
                        </label>
                    </div>
                  </div>
                  <div className="flex pt-2">
                    <button type="submit" className="flex min-w-[84px] w-full cursor-pointer items-center justify-center overflow-hidden rounded-lg h-12 px-5 bg-primary-dark text-white text-base font-bold leading-normal tracking-wide hover:bg-primary-dark/90 focus:outline-none focus:ring-4 focus:ring-primary/30 transition-colors duration-200 shadow-lg">
                      <span className="truncate">Access Portal</span>
                    </button>
                  </div>
                </form>
              </div>
